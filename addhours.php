...
//	print_r($_POST);
	...
	// set up my query
	$query = "INSERT INTO Hours(startDate, endDate, hoursWorked, jobID) VALUES ('$startdate', '$enddate', '$hours', '$jobID');";
...
<div class="form-group">
	<label for="hours">Please enter the total hours worked</label>
	<input type="hours" class="form-control" name="hours"/>
</div>
